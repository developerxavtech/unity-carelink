            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted">Communicate with families and staff</p>
                    </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-0">
                        @forelse($conversations as $conversation)
                            <a href="{{ route('program.messages.show', $conversation->id) }}"
                        ...
                        @empty
                            <div class="text-center py-5">
                                ...
                                <p class="small text-muted">Start a new conversation to communicate with families and staff.</p>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <button class="btn btn-outline-primary w-100 mb-2" disabled>
                                    <i class="bi bi-people"></i> Message All Families
                                </button>
                            </div>
                            <div class="col-md-4">
                                <button class="btn btn-outline-secondary w-100 mb-2" disabled>
                                    <i class="bi bi-person-badge"></i> Message DSP Staff
                                </button>
                            </div>
                            <div class="col-md-4">
                                <button class="btn btn-outline-info w-100 mb-2" disabled>
                                    <i class="bi bi-building"></i> Program Admin
                                </button>
                            </div>
                        </div>
                    </div>

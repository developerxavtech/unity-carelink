        ...
        <div class="col-lg-8 mx-auto">
            <div class="card dashboard-card">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0">New Individual Profile</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('individuals.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('pronouns') is-invalid @enderror"
                                       id="pronouns" name="pronouns" value="{{ old('pronouns') }}" placeholder="e.g., He/Him, She/Her, They/Them">
                                @error('pronouns')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('strengths_abilities') is-invalid @enderror"
                                      id="strengths_abilities" name="strengths_abilities" rows="3">{{ old('strengths_abilities') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('preferences_interests') is-invalid @enderror"
                                      id="preferences_interests" name="preferences_interests" rows="3">{{ old('preferences_interests') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('communication_style') is-invalid @enderror"
                                      id="communication_style" name="communication_style" rows="2">{{ old('communication_style') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('sensory_profile') is-invalid @enderror"
                                      id="sensory_profile" name="sensory_profile" rows="2">{{ old('sensory_profile') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('triggers') is-invalid @enderror"
                                      id="triggers" name="triggers" rows="2">{{ old('triggers') }}</textarea>
                            @error('triggers')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('calming_strategies') is-invalid @enderror"
                                      id="calming_strategies" name="calming_strategies" rows="2">{{ old('calming_strategies') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('safety_notes') is-invalid @enderror"
                                      id="safety_notes" name="safety_notes" rows="2">{{ old('safety_notes') }}</textarea>
                            @error('safety_notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">Important safety information, allergies, medications</small>
                        </div>

...
class RideRequested implements ShouldBroadcastNow
{
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'pickup_lat' => (float) $this->ride->pickup_latitude,
            'pickup_lng' => (float) $this->ride->pickup_longitude,
            ...
            'destination_lat' => (float) $this->ride->destination_latitude,
            'destination_lng' => (float) $this->ride->destination_longitude,
